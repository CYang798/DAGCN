...
from model.model_pb import get_model, LightingFullBatchModelWrapper
...
def find():
    ...
    # 直接使用已经下载和处理过的数据集路径
    if args.dataset in ['chameleon', 'squirrel', 'directed_roman_empire', 'cora_ml', 'citeseer_full']:
